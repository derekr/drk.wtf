...
var fs = __toESM(require("fs/promises")), import_path = require("path"), import_core = __toESM(require("highlight.js/lib/core")), import_jsx_dev_runtime = require("react/jsx-dev-runtime");
var loader4 = async ({ params }) => {
  ...
  return post ? (post.body = await Promise.all(
    post.body.map(async (block) => block._type !== "codeBlock" ? block : {
      ...block,
      code: import_core.default.highlight(block.code, { language: block.language.toUpperCase() }).value
    })
